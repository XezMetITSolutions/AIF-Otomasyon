...
class Database {
    ...
    // Veritabanı ayarları - Web hosting'e göre değiştirilecek
    private $host = 'localhost';
    private $database = 'd0451622';
    private $username = 'd0451622'; // Web hosting'de değiştirilecek
    private $password = '01528797Mb##'; // Web hosting'de değiştirilecek
