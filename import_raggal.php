...
try {
    ...
    foreach ($events as $evt) {
        ...
        if ($check) {
            ...
            $db->query("INSERT INTO toplantilar (byk_id, olusturan_id, baslik, aciklama, toplanti_tarihi, konum, durum, toplanti_turu) VALUES (?, ?, ?, ?, ?, ?, 'planlandi', 'normal')", 
