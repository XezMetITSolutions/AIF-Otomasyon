    <script>
        ...
        async function useTurkishFont(doc){
            try {
                // Direkt fallback helvetica kullan (font yÃ¼kleme hatasÄ± Ã¶nleme)
                doc.setFont('helvetica','');
                console.log('Font yÃ¼kleme atlandÄ±, helvetica kullanÄ±lÄ±yor');
            } catch (e) {
                // Son Ã§are
                doc.setFont('helvetica','');
        ...
        const DEBUG = false; // Konsol Ã§Ä±ktÄ±sÄ±nÄ± azalt
        const geocodeCache = {};
        const routeCache = {};
        ...
        console.warn = function(...args) {
            ...
            if (message.includes('dpt.js') || 
                message.includes('updateTimeDifferenceInterval')) {
                return; // Bu uyarÄ±larÄ± gÃ¶sterme
            }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (ibanEl) {
                ...
                // Ä°lk yÃ¼klemede de AT ile baÅŸlat
        ...
        function addItem() {
            ...
            newItem.innerHTML = `
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>BÃ¶lge YÃ¶netim Kurulu</label>
                ...
                <div class="form-group desc-fields" style="display:none;">
                    ...
                    <textarea name="beschreibung[]" rows="2" placeholder="KÄ±sa aÃ§Ä±klama"></textarea>
                </div>
                <div class="form-group">
        ...
        // Global resim yÃ¼kleme kaldÄ±rÄ±ldÄ±; her kalem iÃ§in ayrÄ± dosya alanÄ± zaten mevcut
        ...
        async function generatePDFLocal() {
            ...
            for (const position of Array.from(positions)) {
                ...
                if (giderTuru === 'ulasim') {
                    ...
                    itemsForBackend.push({ tarih: datum, region, birim, birim_label: birimLabel, gider_turu: giderTuru, gider_turu_label: giderTuruLabel, tutar: parseFloat(giderMiktari) || 0, aciklama: beschreibung, rota: route, km: parseFloat(kilometer) || 0 });
                } else {
                    itemsForBackend.push({ tarih: datum, region, birim, birim_label: birimLabel, gider_turu: giderTuru, gider_turu_label: giderTuruLabel, tutar: parseFloat(giderMiktari) || 0, aciklama: beschreibung });
                }
