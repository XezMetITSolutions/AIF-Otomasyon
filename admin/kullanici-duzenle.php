...
try {
    $bykList = $db->fetchAll("SELECT id as byk_id, name as byk_adi, code as byk_kodu FROM byk_categories WHERE UPPER(code) IN ('AT', 'GT', 'KGT', 'KT') ORDER BY code");
} catch (Exception $e) {
    // byk_categories yoksa eski byk tablosunu kullan
    $bykList = $db->fetchAll("SELECT * FROM byk WHERE aktif = 1 AND UPPER(byk_kodu) IN ('AT', 'GT', 'KGT', 'KT') ORDER BY byk_adi");
}
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="ad"
                                value="<?php echo htmlspecialchars($_POST['ad'] ?? $kullanici['ad']); ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Soyad <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="soyad"
                                value="<?php echo htmlspecialchars($_POST['soyad'] ?? $kullanici['soyad']); ?>"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control" name="email"
                                value="<?php echo htmlspecialchars($_POST['email'] ?? $kullanici['email']); ?>"
                                required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Yeni Şifre <small class="text-muted">(Değiştirmek istemiyorsanız
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="divan_uyesi" id="divan_uyesi"
                                value="1" <?php echo (isset($_POST['divan_uyesi']) ? $_POST['divan_uyesi'] : ($kullanici['divan_uyesi'] ?? 0)) ? 'checked' : ''; ?>>
