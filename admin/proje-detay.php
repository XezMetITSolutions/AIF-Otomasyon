                                    ...
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="d-flex align-items-center mb-1">
                                                ...
                                                <a href="dosya-indir.php?path=<?php echo urlencode($file['dosya_yolu']); ?>" target="_blank" class="fw-bold text-decoration-none text-dark"><?php echo htmlspecialchars($file['dosya_adi']); ?></a>
                                        ...
                                        <a href="dosya-indir.php?path=<?php echo urlencode($file['dosya_yolu']); ?>&download=1" target="_blank" class="btn btn-sm btn-outline-primary"><i class="fas fa-download"></i></a>
                                    </div>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
