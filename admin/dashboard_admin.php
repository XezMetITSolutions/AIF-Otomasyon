...
<body>
                ...
                <div class="col-lg-4 mb-3">
                    <div class="page-card admin-management">
                        <div class="card-body text-center">
                            ...
                            <h5>Code List Yönetimi</h5>
                            <p class="mb-3">Dropdown seçeneklerini ve sistem kodlarını yönetin</p>
                            <a href="code_list.php" class="btn btn-light">
                                <i class="fas fa-list"></i> Yönet
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-3">
                    <div class="page-card admin-reports">
                        <div class="card-body text-center">
                            ...
                            <h5>Harcama Yönetimi</h5>
                            <p class="mb-3">Giderleri takip edin ve onaylayın</p>
                            <a href="expenses.php" class="btn btn-light">
                                <i class="fas fa-euro-sign"></i> Yönet
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <button class="btn btn-outline-primary w-100" onclick="quickAction('newUser')">
                                <i class="fas fa-user-plus"></i><br>
                                <small>Yeni Kullanıcı</small>
                            </button>
                        </div>
                        <div class="col-md-3 mb-3">
    ...
    <script>
        ...
        function quickAction(action) {
            switch(action) {
                case 'newUser':
                    window.location.href = 'user_permissions.php';
                    break;
                case 'newMeeting':
