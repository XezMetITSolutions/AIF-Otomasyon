...
// Yetki Kontrolü
$isSuperAdmin = $auth->hasRole('super_admin'); // Varsayım
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 fs-5 text-success"><?php echo number_format($talep['tutar'], 2, ',', '.'); ?> TL</div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 text-muted">Açıklama</div>
                            <div class="col-md-8"><?php echo nl2br(htmlspecialchars($talep['aciklama'] ?? '-')); ?></div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 text-muted">Tarih</div>
                            <div class="col-md-8"><?php echo date('d.m.Y H:i', strtotime($talep['olusturma_tarihi'])); ?></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="position-relative m-4">
                            <div class="progress" style="height: 1px;">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo ($currentStage-1)*50; ?>%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="position-absolute top-0 start-0 translate-middle btn btn-sm btn-<?php echo ($currentStage > 1 || $talep['durum'] == 'onaylandi') ? 'success' : 'primary'; ?> rounded-pill" style="width: 2rem; height:2rem;">1</div>
                            <div class="position-absolute top-0 start-50 translate-middle btn btn-sm btn-<?php echo ($currentStage > 2 || $talep['durum'] == 'onaylandi') ? 'success' : ($currentStage == 2 ? 'primary' : 'secondary'); ?> rounded-pill" style="width: 2rem; height:2rem;">2</div>
                            <div class="position-absolute top-0 start-100 translate-middle btn btn-sm btn-<?php echo ($currentStage == 3) ? 'success' : 'secondary'; ?> rounded-pill" style="width: 2rem; height:2rem;">3</div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="bg-secondary rounded-circle d-flex align-items-center justify-content-center text-white me-3" style="width: 50px; height: 50px; font-size: 1.2rem;">
                                <?php echo strtoupper(substr($talep['kullanici_adi'], 0, 1)); ?>
                            </div>
                            <div>
                                <h6 class="mb-0"><?php echo htmlspecialchars($talep['kullanici_adi']); ?></h6>
                                <small class="text-muted"><?php echo htmlspecialchars($talep['byk_adi']); ?> (<?php echo $talep['byk_kodu']; ?>)</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <p class="text-muted small">
                                Şu anki Aşama: <strong><?php echo ($currentStage == 1) ? 'Birim Onayı Bekleniyor' : 'AT Onayı Bekleniyor'; ?></strong>
                            </p>
                                ...
                                <?php else: ?>
                                    <div class="alert alert-warning small">
                                        <?php if ($currentStage == 1): ?>
                                            Bu talebi sadece <strong><?php echo htmlspecialchars($talep['byk_adi']); ?></strong> muhasebe başkanı onaylayabilir.
