...
<body>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">
                                        ...
                                        Henüz toplantı raporu bulunmamaktadır.
                                        <br><br>
                                        <button class="btn btn-primary" onclick="addReport()">
                                            <i class="fas fa-plus"></i> İlk Raporu Ekle
                                        </button>
                                    </td>
                                </tr>
                            </tbody>
    ...
    <script>
        function addReport() {
            showAlert('Toplantı raporu ekleme özelliği aktif!', 'success');
            console.log('Adding meeting report...');
        }
