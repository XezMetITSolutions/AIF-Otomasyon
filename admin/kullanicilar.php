                                    ...
                                    <?php foreach ($kullanicilar as $kullanici): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <span class="badge bg-info"><?php echo htmlspecialchars($kullanici['rol_adi']); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                            ...
                            <ul class="pagination justify-content-center">
                                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                    <li class="page-item <?php echo $i === $page ? 'active' : ''; ?>">
                                        <a class="page-link" href="?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&rol=<?php echo urlencode($roleFilter); ?>&byk=<?php echo urlencode($bykFilter); ?>&status=<?php echo urlencode($statusFilter); ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php endfor; ?>
