...
try {
    $bykList = $db->fetchAll("SELECT id as byk_id, name as byk_adi, code as byk_kodu, color as byk_renk FROM byk_categories WHERE code IN ('AT', 'GT', 'KGT', 'KT') ORDER BY code");
} catch (Exception $e) {
