...
<main class="container-fluid mt-4">
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0"><i class="fas fa-users-cog me-2"></i>Modül ve Yetki Yönetimi</h1>
        </div>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                        <tr class="text-secondary small text-uppercase">
                                            ...
                                            <th class="text-center" style="width: 30%;">Başkan Yetkisi<br><span class="text-muted fw-normal text-lowercase">(Yönetici)</span></th>
                                            <th class="text-center" style="width: 35%;">Üye Yetkisi<br><span class="text-muted fw-normal text-lowercase">(Kullanıcı)</span></th>
                                        </tr>
                                    </thead>
                                    <tbody>
