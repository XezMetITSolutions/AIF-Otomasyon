        ...
        <form method="POST" action="">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control"
                        value="<?php echo htmlspecialchars($toplanti['byk_adi']); ?>" disabled>
                    <small class="text-muted">BYK değiştirilemez</small>
                </div>
                <?php if ($isCreator): ?>
                    <div class="col-md-6 mb-3">
                        <label for="sekreter_id" class="form-label">Toplantı Sekreteri</label>
                        <select class="form-select" id="sekreter_id" name="sekreter_id">
                            <option value="">Seçiniz...</option>
                            <?php foreach ($katilimcilar as $k): ?>
                                <option value="<?php echo $k['kullanici_id']; ?>" <?php echo (isset($toplanti['sekreter_id']) && $toplanti['sekreter_id'] == $k['kullanici_id']) ? 'selected' : ''; ?>>
                                    <?php echo htmlspecialchars($k['ad'] . ' ' . $k['soyad']); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <div class="form-text">Gündem ve karar yazma yetkisi verilecek kişi.</div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="aciklama" name="aciklama"
                    rows="3"><?php echo htmlspecialchars($toplanti['aciklama'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="durum" name="durum">
                    <option value="planlandi" <?php echo $toplanti['durum'] === 'planlandi' ? 'selected' : ''; ?>>
                        Planlandı</option>
                    <option value="devam_ediyor" <?php echo $toplanti['durum'] === 'devam_ediyor' ? 'selected' : ''; ?>>
                        Devam Ediyor</option>
                    <option value="tamamlandi" <?php echo $toplanti['durum'] === 'tamamlandi' ? 'selected' : ''; ?>>
                        Tamamlandı</option>
