            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <form method="POST" id="davetiyeForm"
                        action="/admin/toplanti-duzenle.php?id=<?php echo $toplanti_id; ?>">
                                ...
                                <tbody>
                                    <?php foreach ($katilimcilar as $katilimci): ?>
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                                    <input class="form-check-input katilimci-checkbox" type="checkbox"
                                                        name="selected_participants[]"
                                                        value="<?php echo $katilimci['katilimci_id']; ?>">
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <br>
                                                <small
                                                    class="text-muted"><?php echo htmlspecialchars($katilimci['email']); ?></small>
                                            </td>
                                            <td>
                                                <?php
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="border rounded p-2 bg-light mb-2">
                            <input type="text" class="form-control form-control-sm" id="modal_user_search"
                                placeholder="İsim veya e-posta ara...">
                        </div>

                        <div class="user-list-container border rounded bg-white p-0"
