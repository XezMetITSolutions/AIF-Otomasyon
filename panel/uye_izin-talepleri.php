...
Middleware::requireModulePermission('uye_izin_talepleri');
            ...
            <div class="col-lg-7">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <?php if ($selectedId): ?>
                            <a href="/panel/uye_izin-talepleri.php" class="btn btn-sm btn-outline-secondary">Seçimi Temizle</a>
                        <?php endif; ?>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php foreach ($izinler as $izin): ?>
                                            ...
                                            <tr class="<?php echo $rowSelected; ?>">
                                                ...
                                                <td class="text-end">
                                                    <a href="/panel/uye_izin-talepleri.php?id=<?php echo $izin['izin_id']; ?>" class="btn btn-sm btn-outline-primary">
                                                        Detay
                                                    </a>
                                                </td>
                                            </tr>
