                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-12 col-md">
                        <div class="d-flex gap-2 flex-wrap">
                            <!-- Month Filter -->
                            <select class="form-select form-select-sm" style="width: auto;" onchange="applyFilter('ay', this.value)">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="btn-group">
                            <button class="btn btn-sm <?php echo $view === 'card' ? 'btn-primary' : 'btn-outline-secondary'; ?>" 
                                    onclick="setView('card')" title="Card Görünümü">
                                <i class="fas fa-th"></i>
                            </button>
                            <button class="btn btn-sm <?php echo $view === 'list' ? 'btn-primary' : 'btn-outline-secondary'; ?>" 
                                    ...
                                    <div class="d-flex gap-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="small text-primary mt-1">
                                                <i class="fas fa-building me-1"></i><?php echo htmlspecialchars($toplanti['byk_adi']); ?>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th>Başlık</th>
                                    <?php if ($isAdmin): ?><th>Birim</th><?php endif; ?>
                                    <th>Konum</th>
                                    <th>Katılım</th>
                                    <th>Durum</th>
                                    <?php if ($canManage): ?><th class="text-end pe-4">İşlemler</th><?php endif; ?>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($toplantilar as $toplanti): ?>
                                    ...
                                    <tr class="<?php echo $rowClass; ?>">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2" style="min-width: 120px;">
                                                ...
                                                <small class="text-muted"><?php echo $confirmed; ?>/<?php echo $total; ?></small>
                                            </div>
                                        </td>
                                        <td>
                                            <?php if ($isCancelled): ?>
